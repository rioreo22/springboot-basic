package org.prgrms.vouchermanager.customer.persistence;
...
class CustomerJDBCRepositoryTest {
    ...
    void beforeAll() {
        ...
        testCustomer1 = Customer.create("test_customer1", "test01@email.com");
        testCustomer2 = Customer.create( "test_customer2", "test02@email.com");
    }
    ...
    void insert_고객을_삽입할_수_있다() {
        ...
        Customer foundCustomer1 = customerJdbcRepository.findById(testCustomer1.getId()).get();
        Customer foundCustomer2 = customerJdbcRepository.findById(testCustomer2.getId()).get();
    ...
    void delete_customer_id로_고객을_삭제할_수_있다() {
        //when
        customerJdbcRepository.delete(testCustomer1.getId());

        //then
        assertThat(customerJdbcRepository.findById(testCustomer1.getId())).isEqualTo(Optional.empty());
    }
